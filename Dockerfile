...
RUN adduser infa
WORKDIR "/infa"
RUN wget https://na1.dm-us.informaticacloud.com/saas/download/linux64/installer/agent64_install.bin
#COPY agent64_install.bin /infa/agent64_install.bin
RUN chmod +x /infa/agent64_install.bin
RUN echo -e "\n\n\n\n" | /infa/agent64_install.bin -i silent -DUSER_INSTALL_DIR=/infa/infaagent || echo OK
